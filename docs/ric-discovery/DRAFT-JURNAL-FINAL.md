...
### 2.1 Standar Records in Contexts (ICA RiC-CM v1.0 & RiC-O)
...
### 4.1 Pemetaan Entitas dan Relasi Skema Basis Data
...
### 4.2 Formulasi Contextual Affinity Score ($CAS$)
...
### 4.3 Serialisasi Semantik JSON-LD RiC-O
...
* Duranti, L. (1997). The archival bond. *Archives and Museum Informatics*, 11(3), 213-218.
* ICA Expert Group on Archival Description. (2023). *Records in Contexts: Conceptual Model (RiC-CM v1.0)*. International Council on Archives.
* Llanes-Padrón, D., & Pastor-Sánchez, J. A. (2017). Records in contexts: the road towards semantic archival description. *BiD: textos universitaris de biblioteconomia i documentació*, 38.
* MacNeil, H. (2000). *Trusting records: legal, historical and diplomatic perspectives*. Springer Science & Business Media.
